...
local heroicData = {
    ...
    abilities = {
        ...
        {name = "Defilement of the Crucible", spellID = 1298381, category = "raid damage", phase = 3, times = {2.62, 96.68}, duration = 0},
        {name = "Grim Guillotine", spellID = 1299266, category = "group soak", phase = 3, times = {18, 76.73, 160.22}, duration = 0},
        {name = "Gloombomb", spellID = 1286895, category = "spread", phase = 3, times = {26.95, 85.81, 123.49, 173.97}, duration = 5},
        {name = "Blighted Sever", spellID = 1307292, category = "raid damage, tank debuff, frontal", phase = 3, times = {34.97, 64.5, 95.01, 127.94, 157.42}, duration = 0},
        {name = "Eternal Nightfall", spellID = 1286918, category = "event", phase = 3, times = {37.91, 126.13}, duration = 0},
        {name = "Dreadmarch", spellID = 1285643, category = "cc, add spawn", phase = 3, times = {70.58, 149.33}, duration = 0},
    },
}
