...
local heroicData = {
    ...
    abilities = {
        ...
        {name = "Siphoning Infection", spellID = 1295224, category = "raid debuff", phase = 1, times = {42.34, 94.36, 126.43, 178.42, 210.44, 262.44, 294.44, 346.43, 378.47, 430.46, 462.49, 514.48, 546.48, 598.47, 630.53}, duration = 15},
        {name = "Exploding Infection", spellID = 1295173, category = "raid debuff, spread", phase = 1, times = {42.34, 94.36, 126.43, 178.42, 210.44, 262.44, 294.44, 346.43, 378.47, 430.46, 462.49, 514.48, 546.48, 598.47, 630.53}, duration = 10},
