...
L[3176] = {
    ["Soaks"] = {text = "Soak", name = "Soaks"},
}

-- Vorasius (3177)
L[3177] = {
    ["Breath"] = {text = "Breath", name = "Breath"},
    ["Knock"] = {text = "Knock", name = "Knock"},
}

-- Fallen King Salhadaar (3179)
L[3179] = {
    ["CC Display"] = {name = "CC Display"},
    ["Beams"] = {text = "Beams", name = "Beams"},
    ["CC Adds"] = {text = "CC Adds", name = "CC Adds"},
    ["Orbs"] = {text = "Orbs", name = "Orbs"},
}
...
L[3181] = {
    ...
    ["Boss-Immune"] = {text = "Immune", name = "Boss-Immune"},
...
-- Chimaerus (3306)
L[3306] = {
    ["Debuffs_P1"] = {text = "Debuffs", name = "Debuffs"},
    ["Debuffs_P2"] = {text = "Debuffs", name = "Debuffs"},
}
...
L[3183] = {
    ...
    ["CrystalDropTimer"] = {text = "PICK UP", name = "Time to Pick Crystal"},
...
L[3420] = {
    ...
    ["WindsHelper"] = {name = "Winds Helper", group = "Sszorak"},
