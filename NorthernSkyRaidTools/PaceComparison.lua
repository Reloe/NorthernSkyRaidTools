...
NSI.PaceComparisonDefaults = {
    ...
    [3429] = { -- The Coiled Altar
        thresholds = {
            ...
            {phase = 1, time = 140, unit = "boss1", expected = 16.5},
            {phase = 1, time = 150, unit = "boss1", expected = 9.5},
            {phase = 1, time = 160, unit = "boss1", expected = 4.2},
            ...
            {phase = 2, time = 160, unit = "boss2", expected = 18},
