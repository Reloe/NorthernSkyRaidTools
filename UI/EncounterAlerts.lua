...
local function BuildEncounterAlertsUI(parentFrame)
    ...
    searchHint:SetFont(NSI.LSM:Fetch("font", NSRT.Settings.GlobalFont), 14, NSRT.Settings.GlobalFontFlags or "")
    searchHint:SetText("|TInterface\\Addons\\NorthernSkyRaidTools\\Media\\Icons\\search.png:14:14:0:-2|t  Search...")
