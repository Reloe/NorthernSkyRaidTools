...
local heroicAbilities = {
        ...
        {name = "Tempest", spellID = 1287072, category = "raid damage, movement", phase = 1, times = {13.09, 65.3, 151.22, 203.45, 289.35, 341.6, 427.5}, duration = 8},
...
local mythicAbilities = {
        ...
        {name = "Tempest", spellID = 1287072, category = "raid damage, movement", phase = 1, times = {12.53, 59.51, 139.53, 186.51, 266.53, 313.51, 393.53, 440.51}, duration = 8},
