...
L["Korean (koKR)"] = true
L["Russian (ruRU)"] = true
L["Simplified Chinese (zhCN)"] = true
...
L["Automatically Enable New Alerts"] = true
L["Automatically enables all future Alerts unless they are specifically marked as being default disabled."] = true
